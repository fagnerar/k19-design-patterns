...
<head>
	...
	<title>Lançar Despesa | Advocacia - AM</title>
</head>
<body>
	<div id="container">

		<jsp:include page="common/header.jsp">
			<jsp:param name="titulo" value="Lançar Despesa" />
		</jsp:include>

		<jsp:include page="common/menu.html" />
		
		<form action="lancarDespSetup" method="post">
			<div>
				<div class="inline">
			...
			<div>
				<div class="inline">
					...
					<select name="despesa" id="despesa">
						...
						<option value="${td.descricao}">${td.descricao}</option>
						</c:forEach>
				...
				<div class="inline">
					<label for="dataDespesa">Data da Despesa: </label><input type="text" name="dataDespesa" id="dataDespesa" />
				</div>
			</div>
			<div>
				<div class="inline">
					<label for="valorDespesa">Valor da Despesa: </label><input type="text" name="valorDespesa" id="valorDespesa" />
				</div>
				<div class="inline">
